...
TauApplication::TauApplication(int &argc, char **argv, bool _waitForScreenshotReady):
...
TauApplication::~TauApplication()
{

}

void TauApplication::addExportStepFunctor(const std::function<void ()> &f)
{
    functors<<Data(f);
}

void TauApplication::addExportStepPlot(JKQTPlotter *plot)
{
    functors<<Data(plot);
}

void TauApplication::addExportStepPlotFunctor(const std::function<JKQTPlotter *()> &fplot)
{
    functors<<Data(fplot);
}

void TauApplication::readCmdLine() {
...
QRect TauApplication::getBoundsWithoutColor(QImage qImage, const QColor &exclusionColor)
{
    QRect ofTheKing;
...
void TauApplication::saveWidget(QWidget *w, int iVisible) {
...
void TauApplication::notifyReadyForScreenshot()
{

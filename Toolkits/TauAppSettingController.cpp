...
TauAppSettingController::TauAppSettingController(int &argc, char **argv, bool enableHighDPIIfAVailable) {
    // seed RNG
    std::srand(123456);
...
TauAppSettingController::~TauAppSettingController() = default;